...
// Rispetto alle implementazioni degli algoritmi O(n^2), sono stati aggiunti gli indici p e r
int main() {
    randfiller filler;
    ...
    for (int i = 0; i < 100; ++i) {
        ...
        quick_sort(vec, 0, size - 1);  // ...E non solo: "quick_sort(vec)"; l'algoritmo richiede 3 parametri
    ...
    quick_sort(str_vec, 0, (int)str_vec.size() - 1);
